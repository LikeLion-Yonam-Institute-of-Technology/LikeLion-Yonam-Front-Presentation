...
import {
  Week6Welcome,
  Week6Goals,
} from "../components/week6/0_Intro.jsx";
import {
  StateMentalModel,
  StateClosureAndRender,
  StateRerenderMechanism,
  StateQueueAndBatching,
  RenderingDefinition,
  RenderingTriggers,
  RenderCommitPhases,
  RenderingBailoutAndImmutability,
  RenderingOptimization,
  UseStateCounter,
  EventHandlingForms,
  ListAddDelete,
  FilteringDerivedState,
  UseEffectBasics,
  UseEffectDeepDive,
  UseEffectCleanupWhy,
  UseEffectCleanupCases,
  EffectClosureAndAsyncState,
  AsyncStateDebugPattern,
  FetchWithEffect,
  CustomHookIntro,
  RouterConcept,
  RouterApproaches,
  PageStateRoutingExample,
  HashRouterExample,
  BrowserRouterExample,
  DataRouterExample,
  FileBasedRoutingExample,
  ReactRouterPractice,
  Week6MissionPreview,
  Week6Mission,
  Week6WrapUp,
} from "../components/week6/1_StateEffect.jsx";
import {
  VanillaPainPoint,
  WhatIsReact,
...
export const weeklySlides = {
  ...
  6: {
    title: "WEEK 06 : 상태(State)와 Effect",
    slides: [
      Week6Welcome,
      Week6Goals,
      StateMentalModel,
